...
#@jit
@vectorize(['int32(int32,int32,int32,int)'], target = 'cuda')
#@cuda.jit(device=True)
def funcz(all_ram_of_selected_discriminator,t_ratina,image,i):
...
#        print(image)
        ...
        for i in range(98):
            i = i.astype(np.int32)
            funcz(all_ram_of_selected_discriminator,t_ratina,image,i)

...
#    print(px_test[0].shape)
    ...
    train_the_network = train_discriminator_with_bleaching(d,acc_pos,px_train[0:5000],py_train[0:5000])
    #print(view)
    #print(x_test[1])
    #print(d[0][0])
    right,wrong = test_discriminator_with_bleaching(d,acc_pos,px_test[0:1000],py_test[0:1000])
